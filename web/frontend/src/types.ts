...
export interface Dashboard {
 ...
 strategy_live: { mode: 'intraday' | 'pending_close' | 'formal' | 'unavailable'; available: boolean; complete: boolean; valuation_date: string; formal_date: string; quote_time: string; missing_codes: string[]; daily_pnl: number | null; estimated_assets: number | null; warnings: string[] };
 strategy: { summary: Row; daily: Row[]; positions: Row[]; trades: Row[]; components: Row[]; warnings: string[]; errors: string[] };
