...
POSITION_INDEX_TIMING_STRATEGIES = _timing.POSITION_INDEX_TIMING_STRATEGIES
...
POSITION_TIMING_TRADE_ACTION_COLUMNS = _performance.POSITION_TIMING_TRADE_ACTION_COLUMNS
...
PositionTimingTradePreviewResult = _performance.PositionTimingTradePreviewResult
PositionTimingTradePreviewResult.__module__ = __name__
...
def build_position_timing_trade_preview(items: list[PositionItem], quotes: dict[str, dict[str, object]], *, market_now: datetime | None=None, start_date: str | pd.Timestamp=POSITION_TIMING_START_DATE, initial_capital: float=POSITION_TIMING_INITIAL_CAPITAL, transaction_cost: float=POSITION_TIMING_TRANSACTION_COST, lot_size: int=POSITION_TIMING_LOT_SIZE) -> PositionTimingTradePreviewResult:
    return _call(_performance, 'build_position_timing_trade_preview', items, quotes, market_now=market_now, start_date=start_date, initial_capital=initial_capital, transaction_cost=transaction_cost, lot_size=lot_size)
...
_PATCHABLE_NAMES.extend([
    ...
    'POSITION_TIMING_PARKING_SYMBOL', 'POSITION_TIMING_TRADE_ACTION_COLUMNS',
    'PositionTimingPerformanceResult', 'PositionTimingTradePreviewResult',
    'build_position_timing_performance', 'build_position_timing_trade_preview',
    'POSITION_INDEX_TIMING_STRATEGIES', 'build_position_index_timing_table',
