...
PORTFOLIO_INITIAL_ENTRY_FOLLOW_STATE = "follow_state"
PORTFOLIO_INITIAL_ENTRY_FRESH_BUY = "fresh_buy"
PORTFOLIO_INITIAL_ENTRY_POLICIES = (
    PORTFOLIO_INITIAL_ENTRY_FOLLOW_STATE,
    PORTFOLIO_INITIAL_ENTRY_FRESH_BUY,
)
PORTFOLIO_EMPTY_ACTIVATION_IMMEDIATE = "immediate"
PORTFOLIO_EMPTY_ACTIVATION_AFTER_PRIMARY_ENTRY = "after_primary_entry"
...
class PortfolioTimingAllocation:
    ...
    initial_entry_policy: str = PORTFOLIO_INITIAL_ENTRY_FOLLOW_STATE
    empty_position_symbol: str = ""
    empty_position_activation: str = PORTFOLIO_EMPTY_ACTIVATION_IMMEDIATE
